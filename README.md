...
It involves a smart contract raffle where users can enter a random raffle. And using Chainlink's offchain upkeep functionalty, it enables true randomness.
