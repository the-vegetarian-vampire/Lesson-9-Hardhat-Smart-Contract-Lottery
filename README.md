...
This is Lesson 9 deployed on the Sepolia testnet. 
- It involves a smart contract raffle where users can enter a random raffle.
- Using Chainlink's offchain upkeep functionalty, it enables true randomness.
